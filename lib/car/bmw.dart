  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            bmwcar("BMW X1", '60L', 'Four', '55000/Day',
                'assets/images/bmw/bmw1.png'),
            bmwcar("BMW X2", '67L', 'Four', '60000/Day',
                'assets/images/bmw/bmw2.png'),
            bmwcar("BMW X3", '80L', 'Four', '57000/Day',
                'assets/images/bmw/bmw6.png'),
            bmwcar("BMW X4", '70L', 'Four', '66000/Day',
                'assets/images/bmw/bmw8.png'),
            bmwcar("BMW X5", '60L', 'Four', '60000/Day',
                'assets/images/bmw/bmw9.png'),
          ],
        ),
      ),
    );
