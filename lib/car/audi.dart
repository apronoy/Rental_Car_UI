...
class _audiState extends State<audi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            bmwcar("Audi r1", '60L', 'Four', '55000/Day',
                'assets/images/audi/audi.png'),
            bmwcar("Audi r2", '67L', 'Three', '60000/Day',
                'assets/images/audi/audi2.png'),
            bmwcar("Audi r3", '80L', 'Four', '57000/Day',
                'assets/images/audi/audi3.png'),
            bmwcar("Audi r4", '70L', 'Three', '66000/Day',
                'assets/images/audi/audi4.png'),
            bmwcar("Audi r5", '60L', 'Three', '60000/Day',
                'assets/images/audi/audi5.png'),
          ],
        ),
      ),
    );
  ...
  Widget bmwcar(var name, oil, cepa, price, image) {
    return Container(
