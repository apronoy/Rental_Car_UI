...
class _tataState extends State<tata> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            tatacar("Tata t1", '60L', 'Six', '30000/Day',
                'assets/images/tata/tata.png'),
            tatacar("Tata t2", '60L', 'Six', '30000/Day',
                'assets/images/tata/tata2.png'),
            tatacar("Tata t3", '60L', 'Six', '30000/Day',
                'assets/images/tata/tata3.png'),
            tatacar("Tata t4", '60L', 'Six', '30000/Day',
                'assets/images/tata/tata4.png'),
            tatacar("Tata t5", '60L', 'Six', '30000/Day',
                'assets/images/tata/tata5.png'),
           ],
        ),
      ),
    );
  ...
  Widget tatacar(var name, oil, cepa, price, image) {
    return Container(
